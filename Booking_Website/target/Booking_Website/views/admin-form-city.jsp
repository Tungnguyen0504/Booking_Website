                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">${action eq 'add' ? "Thêm" : "Chỉnh sửa"} thông tin thành phố</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/admin-index"><i
                                    class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a
                                    href="${pageContext.request.contextPath}/admin-manage-city">Quản lý tỉnh thành</a></li>
                            <li class="breadcrumb-item active"
                                aria-current="page">${action eq 'add' ? "Thêm" : "Chỉnh sửa"} thông tin tỉnh thành
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <c:if test="${action eq 'add'}">
                            <form action="<%=request.getContextPath()%>/admin-manage-city?action=addCity"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="cityName"
                                                   placeholder="Nhập tên thành phố ..." required>
                        ...
                        <c:if test="${action eq 'update'}">
                            <form action="<%=request.getContextPath()%>/admin-manage-city?action=updateCity"
                                  method="post" enctype="multipart/form-data"
                                  class="needs-validation" novalidate>
                            ...
                            <script>
                                $(document).ready(function () {
                                    $('#image-update').fileinput({
                                        allowedFileTypes: ["image"],
                                        initialPreview: ['<c:url value="/uploads/city/${city.cityImage}"/>'],
